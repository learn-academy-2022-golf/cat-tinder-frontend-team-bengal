...
Pushed to main, need to remember -M attribute for master -> main
asked for branch protections
with github and trello up-to-date
...
ran <> $ yarn start, worked beautifully
